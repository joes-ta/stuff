...
int main(void) {
    ...
    result = getaddrinfo("localhost", "12349", &hintsAddrInfo, &hostAddrInfo);//Attempt to contact "localhost" at port 12345//List of address structures
       ...
       // printf("Bytes Sent: %d\n", result);//printf("From Client\n");
        ...
        if (result > 0) {
            ...
            if (preview < 1000 && ret != 0) {
                ...
                printf("\n");
                preview += result;
            } //Preview limits to 1000 characters printed.
